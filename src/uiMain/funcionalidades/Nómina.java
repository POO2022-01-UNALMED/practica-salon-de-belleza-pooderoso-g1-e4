...
public class N髆ina {
	...
	public static void main(String[] args) {
		Empleado empleado1 =new Empleado("Marlon", "Nivia", 1000349061, 21, 32088456, "U锟絘s");
/*>>>>>>> Stashed changes*/
		...
		System.out.println("Pago n贸mina mes vencido");
		...
		//LOS EMPLEADOS
			...
			//Productos que vendi贸 el empleado
			...
			System.out.println("El empleado " +empleado+ " atendi贸 "+ citasMes.size()+" citas en el mes");
			System.out.println("Tiene un sueldo base de:  "+ Empleado.sueldo);
			System.out.println(" ");
			
			System.out.println("Y vendi贸: "+ ventasMes.size()+ " producto(s) en el mes, correspondientes a:");
			System.out.println(" ");
			for(Venta venta: ventasMes) {
				System.out.println("  --> "+venta.getProductoVendido().getNombreProducto()+ " $ "+venta.getProductoVendido().getPrecioVenta());
				}
			System.out.println(" ");
			System.out.println("Por lo que recibe una comisi贸n del 20% de cada producto, es decir: "+totalComi);
		
			System.out.println(" ");
			double totalTodo= Empleado.sueldo + totalComi;
			System.out.println("Confirmaci贸n:");
